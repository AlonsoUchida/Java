  ...
  <body ng-app="myApp" class="ng-cloak">
      <div class="generic-container" ng-controller="UsuarioController as ctrl">
          <div class="panel panel-default">
              ...
              <div class="formcontainer">
                  <form ng-submit="ctrl.submit()" name="myForm" class="form-horizontal">
                      ...
                      <div class="row">
                          <div class="form-group col-md-12">
                              <label class="col-md-2 control-lable" for="direccion">Direccion</label>
                              <div class="col-md-7">
                                  <input type="text" ng-model="ctrl.usuario.direccion" id="direccion" class="form-control input-sm" placeholder="Ingresa tu direccion."/>
                              </div>
                          </div>
                      </div>
                      ...
                      <div class="row">
                          <div class="form-group col-md-12">
                              <label class="col-md-2 control-lable" for="email">Correo</label>
                              <div class="col-md-7">
          ...
          <div class="panel panel-default">
              ...
              <div class="panel-heading"><span class="lead"> Lista de Bodegueros </span></div>
                  ...
                  <table class="table table-hover">
                      ...
                      <tbody>
                          <tr ng-repeat="u in ctrl.usuarios">
                              ...
                              <td><span ng-bind="u.genero"></span></td>
                              <td><span ng-bind="u.tipo_documento"></span></td>
                              <td><span ng-bind="u.valor_documento"></span></td>
                              <td>
