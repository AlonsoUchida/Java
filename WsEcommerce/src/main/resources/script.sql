...
Source Database       : cms_valmar_db

Target Server Type    : MYSQL
Target Server Version : 50711
File Encoding         : 65001

Date: 2016-06-06 11:05:15
*/
DROP DATABASE IF EXISTS CMS_VALMAR_DB; 	
CREATE DATABASE CMS_VALMAR_DB;
USE CMS_VALMAR_DB;
...
CREATE TABLE `cliente_direccion` (
  ...
  CONSTRAINT `clientes_direcciones_ibfk_1` FOREIGN KEY (`id_direccion`) REFERENCES `direccion` (`id`),
  CONSTRAINT `clientes_direcciones_ibfk_2` FOREIGN KEY (`id_cliente`) REFERENCES `cliente` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of clientes_direcciones
-- ----------------------------
...
CREATE TABLE `direccion` (
  ...
  CONSTRAINT `direcciones_ibfk_1` FOREIGN KEY (`id_departamento`) REFERENCES `departamento` (`id`),
  CONSTRAINT `direcciones_ibfk_2` FOREIGN KEY (`id_provincia`) REFERENCES `provincia` (`id`),
  CONSTRAINT `direcciones_ibfk_3` FOREIGN KEY (`id_distrito`) REFERENCES `distrito` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
-- ----------------------------
-- Table structure for direccion_envio
-- ----------------------------
...
INSERT INTO `usuario` VALUES (1, 'JOSUE', 'MOSQUERA', 'josue.mosquera@valmar.com.pe', 'josue.mosquera', '12345', 1);
INSERT INTO `usuario` VALUES (2, 'ALONSO', 'UCHIDA', 'javier.uchida@valmar.com.pe', 'alonso.uchida', '12345', 1);
INSERT INTO `usuario` VALUES (3, 'VICTOR', 'MALAVER', 'victor.malaver@valmar.com.pe', 'victor.malaver', '12345', 1);
INSERT INTO `usuario` VALUES (4, 'JOHN', 'ORREGO', 'john.orrego@valmar.com.pe', 'john.orrego', '12345', 1);
